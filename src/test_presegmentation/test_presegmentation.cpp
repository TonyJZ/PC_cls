...
// 	}
// 
// 	pcl::PointCloud<pcl::PointXYZ> org_dens_sel_pts;
// 	pcl::copyPointCloud (org_norm_sel_pts, sel_indices, org_dens_sel_pts);
...
/*
	...
	geometry_detect_by_JLinkage(ref_sel_pts, clusters, 3, 0.2);
